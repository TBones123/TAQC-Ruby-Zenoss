...
class InfPage < SitePrism::Page
  autoload(:DeviseTableSection, 'page_objects/sections/inf_page/devise_table_section')
  autoload(:DevisePanelSection, 'page_objects/sections/inf_page/device_panel_section')
  autoload(:GroupsSection, 'page_objects/sections/inf_page/group_section')
  autoload(:SystemSection, 'page_objects/sections/inf_page/system_section')
  autoload(:LocationsSection, 'page_objects/sections/inf_page/location_section')
  autoload(:ComponentGroupsSection, 'page_objects/sections/inf_page/component_section')
  ...
  section :component_groups, ComponentGroupsSection, '#componentGroupsTree-body .x-grid-table'
end
